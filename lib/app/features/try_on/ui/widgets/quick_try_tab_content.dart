...
class QuickTryTabContent extends StatefulWidget {
  const QuickTryTabContent({super.key});

  @override
  State<QuickTryTabContent> createState() => _QuickTryTabContentState();
}

enum TryOnStep { captureUser, captureClothes, processing, result }

class _QuickTryTabContentState extends State<QuickTryTabContent>
  ...
  Widget build(BuildContext context) {
    ...
    // Removed top-level Scaffold to fit in TabBarView properly or used minimal structure
    return Scaffold(
      backgroundColor: Colors.black,
      body: Stack(
        fit: StackFit.expand,
  ...
  Widget _buildResultView() {
    ...
    return Scaffold(
        backgroundColor: Colors.black,
        // Removed Scaffold AppBar for result view to look better in tab, or keep it but simple
        // Actually, having an AppBar inside a tab is okay if it's minimal, but maybe just a header
        // Let's keep a minimal header or just the image with overlay controls
        body: Stack(children: [
          Positioned.fill(
            child: Image.network(
              imageUrl,
          ...
          Positioned(
            ...
            child: ElevatedButton(
              onPressed: () {
                // Just reset to start new Try On
                setState(() {
                  _currentStep = TryOnStep.captureUser;
                  _userImage = null;
                  _clothesImage = null;
