...
import 'package:comby/app/bloc/app_bloc.dart' as _i34;
import 'package:comby/app/data/app_usecase.dart' as _i25;
...
import 'package:comby/app/features/auth/features/splash/data/splash_usecase.dart'
    as _i21;
import 'package:comby/app/features/chat/bloc/chat_bloc.dart' as _i26;
import 'package:comby/app/features/chat/data/chat_usecase.dart' as _i6;
import 'package:comby/app/features/closet/bloc/closet_bloc.dart' as _i35;
...
import 'package:comby/core/data_sources/firebase_module_firestore.dart' as _i39;
import 'package:comby/core/data_sources/local_data_source/secure_data_storage.dart'
    as _i18;
import 'package:comby/core/injection/modules/dio_module.dart' as _i38;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.ChatUseCase>(() => _i6.ChatUseCase());
    gh.singleton<_i7.Dio>(() => dioModule.dio());
    ...
    gh.singleton<_i10.FirebaseStorage>(() => registerModule.firebaseStorage);
    ...
    gh.factory<_i25.AppUseCase>(() => _i25.AppUseCase(
          gh<_i18.SecureDataStorage>(),
          firestore: gh<_i9.FirebaseFirestore>(),
        ));
    gh.factory<_i26.ChatBloc>(() => _i26.ChatBloc(gh<_i6.ChatUseCase>()));
    gh.factory<_i27.ClosetUseCase>(() => _i27.ClosetUseCase(
          firestore: gh<_i9.FirebaseFirestore>(),
          auth: gh<_i8.FirebaseAuth>(),
          storage: gh<_i10.FirebaseStorage>(),
        ));
    ...
    gh.singleton<_i34.AppBloc>(
        () => _i34.AppBloc(appUsecase: gh<_i25.AppUseCase>()));
    gh.singleton<_i35.ClosetBloc>(
        () => _i35.ClosetBloc(closetUseCase: gh<_i27.ClosetUseCase>()));
    gh.singleton<_i36.CreateAccountBloc>(() => _i36.CreateAccountBloc(
        createAccountUseCase: gh<_i28.CreateAccountUseCase>()));
    gh.singleton<_i37.ProfileBloc>(() => _i37.ProfileBloc(
          loginUseCase: gh<_i15.LoginUseCase>(),
          createAccountUseCase: gh<_i28.CreateAccountUseCase>(),
...
class _$FirebaseModuleFirestore extends _i39.FirebaseModuleFirestore {}
