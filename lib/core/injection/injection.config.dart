...
import 'package:comby/app/bloc/app_bloc.dart' as _i40;
import 'package:comby/app/data/app_usecase.dart' as _i29;
...
import 'package:comby/app/features/auth/features/splash/data/splash_usecase.dart'
    as _i23;
import 'package:comby/app/features/chat/bloc/chat_bloc.dart' as _i46;
import 'package:comby/app/features/chat/data/chat_repository.dart' as _i30;
import 'package:comby/app/features/chat/data/chat_usecase.dart' as _i41;
import 'package:comby/app/features/closet/bloc/closet_bloc.dart' as _i42;
import 'package:comby/app/features/closet/data/closet_usecase.dart' as _i31;
import 'package:comby/app/features/closet/services/closet_analysis_service.dart'
    as _i27;
import 'package:comby/app/features/fal_ai/data/fal_ai_usecase.dart' as _i33;
...
import 'package:comby/app/features/live_stylist/cubit/live_stylist_cubit.dart'
    as _i44;
import 'package:comby/app/features/payment/bloc/payment_bloc.dart' as _i36;
import 'package:comby/app/features/payment/data/payment_usecase.dart' as _i18;
import 'package:comby/app/features/report/bloc/report_bloc.dart' as _i38;
import 'package:comby/app/features/report/data/report_usecase.dart' as _i19;
import 'package:comby/core/data_sources/firebase_module_firestore.dart' as _i48;
import 'package:comby/core/data_sources/local_data_source/secure_data_storage.dart'
    as _i20;
import 'package:comby/core/injection/modules/dio_module.dart' as _i47;
...
import 'package:comby/core/services/agent_service.dart' as _i39;
...
import 'package:comby/core/services/location_service.dart' as _i16;
import 'package:comby/core/services/notification_service.dart' as _i35;
import 'package:comby/core/services/snackbar_service.dart' as _i21;
import 'package:comby/core/services/theme_service.dart' as _i25;
import 'package:comby/core/services/user_preference_service.dart' as _i26;
import 'package:comby/core/services/weather_service.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i20.SecureDataStorage>(
        () => _i20.SecureDataStorage(gh<_i11.FlutterSecureStorage>()));
    ...
    gh.singleton<_i24.StyleDNAService>(() => _i24.StyleDNAService());
    gh.factory<_i25.ThemeService>(() => _i25.ThemeService());
    gh.factory<_i26.UserPreferenceService>(() => _i26.UserPreferenceService());
    gh.singleton<_i27.WardrobeAnalysisService>(
        () => _i27.WardrobeAnalysisService());
    gh.factory<_i28.WeatherService>(
        () => _i28.WeatherService(gh<_i8.FirebaseFirestore>()));
    gh.factory<_i29.AppUseCase>(() => _i29.AppUseCase(
    ...
    gh.factory<_i31.ClosetUseCase>(() => _i31.ClosetUseCase(
          firestore: gh<_i8.FirebaseFirestore>(),
          auth: gh<_i7.FirebaseAuth>(),
          storage: gh<_i9.FirebaseStorage>(),
        ));
    gh.factory<_i32.CreateAccountUseCase>(() => _i32.CreateAccountUseCase(
          auth: gh<_i7.FirebaseAuth>(),
          googleSignIn: gh<_i13.GoogleSignIn>(),
          firestore: gh<_i8.FirebaseFirestore>(),
        ));
    gh.factory<_i33.FalAiUsecase>(() => _i33.FalAiUsecase(
          firestore: gh<_i8.FirebaseFirestore>(),
          auth: gh<_i7.FirebaseAuth>(),
          storage: gh<_i9.FirebaseStorage>(),
        ));
    gh.singleton<_i34.LoginBloc>(() => _i34.LoginBloc(
          loginUseCase: gh<_i17.LoginUseCase>(),
          createAccountUseCase: gh<_i32.CreateAccountUseCase>(),
        ));
    gh.singleton<_i35.NotificationService>(
        () => _i35.NotificationService(gh<_i26.UserPreferenceService>()));
    gh.singleton<_i36.PaymentBloc>(
        () => _i36.PaymentBloc(generateUseCase: gh<_i18.PaymentUsecase>()));
    ...
    gh.singleton<_i38.ReportBloc>(
        () => _i38.ReportBloc(reportUsecase: gh<_i19.ReportUsecase>()));
    gh.factory<_i39.AgentService>(() => _i39.AgentService(
          weatherService: gh<_i28.WeatherService>(),
          closetUseCase: gh<_i31.ClosetUseCase>(),
          falAiUsecase: gh<_i33.FalAiUsecase>(),
          userPreferenceService: gh<_i26.UserPreferenceService>(),
          notificationService: gh<_i35.NotificationService>(),
          locationService: gh<_i16.LocationService>(),
        ));
    gh.singleton<_i40.AppBloc>(
        () => _i40.AppBloc(appUsecase: gh<_i29.AppUseCase>()));
    gh.factory<_i41.ChatUseCase>(() => _i41.ChatUseCase(
          gh<_i31.ClosetUseCase>(),
          gh<_i39.AgentService>(),
          gh<_i12.GeminiRestService>(),
        ));
    gh.singleton<_i42.ClosetBloc>(
        () => _i42.ClosetBloc(closetUseCase: gh<_i31.ClosetUseCase>()));
    gh.singleton<_i43.CreateAccountBloc>(() => _i43.CreateAccountBloc(
        createAccountUseCase: gh<_i32.CreateAccountUseCase>()));
    gh.factory<_i44.LiveStylistCubit>(() => _i44.LiveStylistCubit(
          gh<_i15.LiveAgentService>(),
          gh<_i31.ClosetUseCase>(),
          gh<_i37.ProfileUseCase>(),
          gh<_i7.FirebaseAuth>(),
        ));
    gh.singleton<_i45.ProfileBloc>(() => _i45.ProfileBloc(
          loginUseCase: gh<_i17.LoginUseCase>(),
          createAccountUseCase: gh<_i32.CreateAccountUseCase>(),
          profileUseCase: gh<_i37.ProfileUseCase>(),
        ));
    gh.factory<_i46.ChatBloc>(() => _i46.ChatBloc(
          gh<_i41.ChatUseCase>(),
          gh<_i30.ChatRepository>(),
          gh<_i7.FirebaseAuth>(),
        ));
    return this;
  }
...
class _$FirebaseModuleFirestore extends _i48.FirebaseModuleFirestore {}

class _$RegisterModule extends _i47.RegisterModule {}

class _$SecureStorageModule extends _i49.SecureStorageModule {}
