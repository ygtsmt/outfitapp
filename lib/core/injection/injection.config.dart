...
import 'package:comby/app/features/payment/data/payment_usecase.dart' as _i14;
import 'package:comby/app/features/report/bloc/report_bloc.dart' as _i29;
import 'package:comby/app/features/report/data/report_usecase.dart' as _i15;
...
import 'package:comby/core/services/language_service.dart' as _i12;
import 'package:comby/core/services/snackbar_service.dart' as _i17;
import 'package:comby/core/services/theme_service.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.FitCheckService>(() => _i9.FitCheckService(
          gh<_i6.FirebaseAuth>(),
    ...
    gh.factory<_i14.PaymentUsecase>(() => _i14.PaymentUsecase(
          gh<_i6.FirebaseAuth>(),
          gh<_i8.FirebaseStorage>(),
          firestore: gh<_i7.FirebaseFirestore>(),
        ));
    gh.factory<_i15.ReportUsecase>(() => _i15.ReportUsecase(
          gh<_i6.FirebaseAuth>(),
          firestore: gh<_i7.FirebaseFirestore>(),
        ));
    gh.singleton<_i16.SecureDataStorage>(
        () => _i16.SecureDataStorage(gh<_i10.FlutterSecureStorage>()));
    gh.factory<_i17.SnackBarService>(() => _i17.SnackBarService());
    gh.singleton<_i18.SplashBloc>(() => _i18.SplashBloc());
    gh.factory<_i19.SplashUseCase>(() => const _i19.SplashUseCase());
    gh.factory<_i20.ThemeService>(() => _i20.ThemeService());
    gh.singleton<_i21.WardrobeAnalysisService>(
        () => _i21.WardrobeAnalysisService());
    ...
    gh.singleton<_i27.PaymentBloc>(
        () => _i27.PaymentBloc(generateUseCase: gh<_i14.PaymentUsecase>()));
    gh.factory<_i28.ProfileUseCase>(() => _i28.ProfileUseCase(
          auth: gh<_i6.FirebaseAuth>(),
          googleSignIn: gh<_i11.GoogleSignIn>(),
          firestore: gh<_i7.FirebaseFirestore>(),
          secureDataStorage: gh<_i16.SecureDataStorage>(),
        ));
    gh.singleton<_i29.ReportBloc>(
        () => _i29.ReportBloc(reportUsecase: gh<_i15.ReportUsecase>()));
