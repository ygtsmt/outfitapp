...
import 'package:ginfit/app/bloc/app_bloc.dart' as _i33;
import 'package:ginfit/app/core/services/first_install_bonus_service.dart'
    as _i10;
import 'package:ginfit/app/data/app_usecase.dart' as _i24;
...
import 'package:ginfit/app/features/auth/features/splash/data/splash_usecase.dart'
    as _i21;
import 'package:ginfit/app/features/closet/bloc/closet_bloc.dart' as _i34;
import 'package:ginfit/app/features/closet/data/closet_usecase.dart' as _i25;
import 'package:ginfit/app/features/closet/services/closet_analysis_service.dart'
    as _i5;
import 'package:ginfit/app/features/fal_ai/data/fal_ai_usecase.dart' as _i27;
import 'package:ginfit/app/features/fit_check/services/fit_check_service.dart'
    as _i11;
import 'package:ginfit/app/features/payment/bloc/payment_bloc.dart' as _i29;
import 'package:ginfit/app/features/payment/data/payment_usecase.dart' as _i16;
import 'package:ginfit/app/features/report/bloc/report_bloc.dart' as _i31;
import 'package:ginfit/app/features/report/data/report_usecase.dart' as _i17;
...
import 'package:ginfit/core/data_sources/local_data_source/secure_data_storage.dart'
    as _i18;
import 'package:ginfit/core/injection/modules/dio_module.dart' as _i37;
...
import 'package:ginfit/core/services/snackbar_service.dart' as _i19;
import 'package:ginfit/core/services/theme_service.dart' as _i22;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i18.SecureDataStorage>(
        () => _i18.SecureDataStorage(gh<_i12.FlutterSecureStorage>()));
    ...
    gh.factory<_i23.VideoGenerateUsecase>(() => _i23.VideoGenerateUsecase(
          firestore: gh<_i8.FirebaseFirestore>(),
          auth: gh<_i7.FirebaseAuth>(),
    ...
    gh.singleton<_i29.PaymentBloc>(
        () => _i29.PaymentBloc(generateUseCase: gh<_i16.PaymentUsecase>()));
    ...
    gh.singleton<_i31.ReportBloc>(
        () => _i31.ReportBloc(reportUsecase: gh<_i17.ReportUsecase>()));
    gh.singleton<_i32.VideoGenerateBloc>(() => _i32.VideoGenerateBloc(
          generateUseCase: gh<_i23.VideoGenerateUsecase>(),
          falAiUsecase: gh<_i27.FalAiUsecase>(),
        ));
    gh.singleton<_i33.AppBloc>(
        () => _i33.AppBloc(appUsecase: gh<_i24.AppUseCase>()));
    gh.singleton<_i34.ClosetBloc>(
        () => _i34.ClosetBloc(closetUseCase: gh<_i25.ClosetUseCase>()));
    gh.singleton<_i35.CreateAccountBloc>(() => _i35.CreateAccountBloc(
        createAccountUseCase: gh<_i26.CreateAccountUseCase>()));
    gh.singleton<_i36.ProfileBloc>(() => _i36.ProfileBloc(
          loginUseCase: gh<_i15.LoginUseCase>(),
          createAccountUseCase: gh<_i26.CreateAccountUseCase>(),
...
class _$FirebaseModuleFirestore extends _i38.FirebaseModuleFirestore {}

class _$RegisterModule extends _i37.RegisterModule {}

class _$SecureStorageModule extends _i39.SecureStorageModule {}
